...
public class CTTCCompaniesJobsPR2Test extends CTTCompaniesJobsPR1Test {
    ...
    public void getLevelTest() throws DSException {
        ...
        Assert.assertEquals(CTTCompaniesJobsPR2.Level.BEGINNER, cttCompaniesJobs.getLevel("workerId3"));
    ...
    public void getSubstitutesByJobOfferTest() throws DSException {
        ...
        Assert.assertEquals(CTTCompaniesJobsPR2.Level.BEGINNER, enrollment1.getWorker().getLevel());

        it1.hasNext();
        Enrollment enrollment2 = it1.next();
        Assert.assertEquals("workerId10",enrollment2.getWorker().getId());
        Assert.assertEquals(CTTCompaniesJobsPR2.Level.BEGINNER, enrollment2.getWorker().getLevel());
        ...
        Assert.assertEquals(CTTCompaniesJobsPR2.Level.BEGINNER, enrollment.getWorker().getLevel());
